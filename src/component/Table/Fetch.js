  ...
  return (
    ...
    >
      <Button
        variant="contained"
        onClick={refreshData}
        style={{ backgroundColor: '#fc7500', color: 'white',marginLeft:'10px', }}
      >
        Refresh Data
      </Button>
      <Button
...
export default function StickyHeadTable() {
  ...
  const fetchData = () => {
    ...
    axios
      .get('http://localhost:8081/h2h_milestone_3/servlet/com.highradius.servlets.DataLoadingServlet')
      .then((response) => {
        // Map the response data to match the 'rows' format if necessary
...
/>
      ...
      <Dialog open={dialogOpen} onClose={handleDialogClose}>
        <DialogTitle className={classes.customTitle}> Delete Records?</DialogTitle>
        <DialogContent>
